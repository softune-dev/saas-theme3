...
export function BannerCtaSection({
    ...
    return (
      <section className="bg-[var(--background)] py-10 md:py-14">
        <div className="w-full px-6 md:px-10">
          <div className="relative select-none bg-stone-50 p-6 sm:p-8 md:p-10">
            <div className="relative z-10 mx-auto max-w-2xl space-y-5 text-center">
              <div className="h-7 sm:h-8 w-64 sm:w-80 mx-auto bg-stone-200 rounded-none" />
              <div className="h-4 w-72 sm:w-96 max-w-full mx-auto bg-stone-200/80 rounded-none" />
              <div className="mx-auto flex max-w-md flex-col items-stretch justify-center gap-3 pt-2 sm:flex-row">
                ...
                <div className="h-10 sm:h-11 w-full sm:w-32 rounded-none bg-stone-200" />
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <section className="bg-[var(--background)] py-10 md:py-14">
      <div className="w-full px-6 md:px-10">
        <div className="relative bg-stone-50 p-6 sm:p-8 md:p-10">
          <div className="relative z-10 mx-auto max-w-2xl space-y-5 text-center">
            {title ? (
              <h2
